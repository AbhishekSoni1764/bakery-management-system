...
for char in msg:
    sys.stdout.write(chalk.blue.bg_magenta_bright.bold.italic.underline(char))
    time.sleep(0.05)
time.sleep(0.2)   
import pandas as pd
...
while n8!='qwerty':
    ...
    while n1!="Exit The System":  
        ...
        if n1=="The Sales Report":
            ...
            print("---------------------------------------------------------------------------------------------------------------------------")
            print("---------------------------------------------------------------------------------------------------------------------------")
            print(chalk.magenta("THANK YOU"),chalk.rgb(255,0,255).bold.italic(n7),chalk.magenta("FOR USING BAKERY MANAGEMENT SYSTEM......."))
            print("---------------------------------------------------------------------------------------------------------------------------")
            print("---------------------------------------------------------------------------------------------------------------------------")
        else:
            print(chalk.red_bright('VALUE ERROR! PLEASE CHECK'))
